...
export default function ReportsScreen() {
  return <AppScreen><Header title="Relatórios" back /><PageScroll className="pt-5"><Field label="Tipo de relatório" value="Dinheiro recebido" /><Field label="Período" value="01/07/2026 até 14/07/2026" />
    ...
    <View className="mt-5 flex-row gap-3"><View className="flex-1"><PrimaryButton label="Filtrar" icon="filter" secondary /></View><View className="flex-1"><PrimaryButton label="Ver detalhes" icon="list" onPress={() => router.push("/finance/report-details")} /></View></View>
